...
(
    ...
    FOREIGN KEY (super_id) REFERENCES Employeee(emp_id)
);
...
(
    ...
    PRIMARY KEY (dept_id),
    FOREIGN KEY (mgr_id) REFERENCES Employeee(emp_id)
);
...
(
	...
	salary_factor DECIMAL(2,1) not null DEFAULT 0 CHECK(salary_factor >=
	0.00),
